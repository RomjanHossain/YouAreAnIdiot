...
static PyObject *impl_gi$_gtktemplate$$$function__2_define_builder_scope$$$function__2_do_create_closure(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    branch_yes_4:;
    {
...

        {
            ...
            tmp_assign_source_12 = impl___main__$$$function__10_complex_call_helper_pos_keywords_star_list(dir_call_args);
        }
    ...
    branch_no_4:;
    {
...

        {
            ...
            tmp_assign_source_13 = impl___main__$$$function__4_complex_call_helper_pos_star_list(dir_call_args);
        }
